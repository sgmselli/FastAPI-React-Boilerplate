    ...
    return (
        <div className="flex flex-col text-color mt-10">
            ...
            <p className="text-sm mt-8">
                Welcome to <span className="underline">FastAPI + React Boilerplate</span>. 
            ...
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">1. Use of the Website</h3>
                <p className="text-sm">
            ...
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">2. Account Registration</h3>
            ...
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">3. Intellectual Property</h3>
                <p className="text-sm">
                    All content on <span className="underline">FastAPI + React Boilerplate</span> — including images, text, PDF files, guitar tabs, and other materials — is protected by copyright.
                </p>
            ...
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">4. User Responsibilities</h3>
                <p className="text-sm">By using the site, you agree NOT to:</p>
            ...
            {/* 5. Downloads */}
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">5. Downloads</h3>
                <p className="text-sm">
            ...
            {/* 6. Third-Party Links */}
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">6. Third-Party Links</h3>
                <p className="text-sm">
            ...
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">7. Disclaimer of Warranties</h3>
                <p className="text-sm">
            ...
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">8. Limitation of Liability</h3>
                <p className="text-sm">
            ...
            <div className="flex flex-col mt-12">
                <h3 className="text-xl font-semibold mb-5">9. Changes to the Website or Terms</h3>
                <p className="text-sm">
            ...
            <div className="flex flex-col mt-12 mb-20">
                <h3 className="text-xl font-semibold mb-5">10. Governing Law</h3>
                <p className="text-sm">
